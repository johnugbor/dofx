		...
		<div className={`market ${LeftToggle ? "market__mini" : ""}`}>
			...
			<div className="stochsearch-header">
				...
				<div className="group-stock-search">
					<select value={groupData} name="trade-group-select" id="main-select" className="group-select" onChange={(e) => onGroupSelectChange(e)} disabled={searchData.length > 0 ? true : false} >
